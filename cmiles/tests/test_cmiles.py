...
@using_rdkit
@pytest.mark.parametrize("input, output", get_smiles_lists(get_fn('drug_bank_stereo.smi'), get_fn('drug_bank_mapped_smi_rd_2020.03.6.smi')))
...
@using_rdkit
@pytest.mark.parametrize("input, output", get_smiles_lists(get_fn('drug_bank_stereo.smi'), get_fn('drug_bank_inchi_rd_2020.03.6.txt')))
...
@using_rdkit
@pytest.mark.parametrize("input, output", get_smiles_lists(get_fn('drug_bank_stereo.smi'), get_fn('drug_bank_inchikey_rd_2020.03.6.txt')))
